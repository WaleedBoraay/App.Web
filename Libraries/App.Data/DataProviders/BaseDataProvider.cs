...
namespace App.Data.DataProviders
{
    public abstract partial class BaseDataProvider
    {
        ...
        protected virtual DataConnection CreateDataConnection(IDataProvider dataProvider)
        {
            ...
            var dataConnection = new DataConnection(dataProvider, CreateDbConnection(), AppMappingSchema.GetMappingSchema(ConfigurationName, LinqToDbDataProvider))
            {
        ...
        public virtual void InitializeDatabase()
        {
            ...
            var targetAssembly = typeof(AppDbStartup).Assembly;
        ...
        public virtual IQueryable<TEntity> GetTable<TEntity>() where TEntity : BaseEntity
        {
            var options = new DataOptions()
                ...
                .UseMappingSchema(AppMappingSchema.GetMappingSchema(ConfigurationName, LinqToDbDataProvider));
        ...
        public virtual async Task BulkInsertEntitiesAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : BaseEntity
        {
            ...
            await dataContext.BulkCopyAsync(new BulkCopyOptions()
            {
                KeepIdentity = true
            }, entities.RetrieveIdentity(dataContext, useSequenceName: false));
        }
