...
namespace App.Data.DataProviders
{
    ...
    /// </summary>
    public partial class MsSqlNopDataProvider : BaseDataProvider, IAppDataProvider
    {
        #region Utilities
        ...
        {
            var connectionString = AppDataSettingsManager.LoadSettings().ConnectionString;
        ...
        public void CreateDatabase(string collation, int triesToConnect = 10)
        {
            ...
            // 2) محاولة الاتصال بعد الإنشاء
            if (triesToConnect <= 0)
                return;

            // sometimes on slow servers the DB takes time to be ready
        ...
        public override IQueryable<TEntity> GetTable<TEntity>()
        {
            ...
            return AppDataSettingsManager.UseNoLock() ? table.With("NOLOCK") : table;
        }
        ...
        public virtual Task<int?> GetTableIdentAsync<TEntity>() where TEntity : BaseEntity
        {
            ...
            var tableName = AppMappingSchema.GetEntityDescriptor(typeof(TEntity)).EntityName;
        ...
        public virtual string BuildConnectionString(IAppConnectionStringInfo nopConnectionString)
        {
