    ...
    public partial class AuditTrailBuilder : EntityBuilder<AuditTrail>
    {
        public override void MapEntity(CreateTableExpressionBuilder table)
        {
            table
                ...
                .WithColumn(nameof(AuditTrail.EntityName)).AsString(256).NotNullable()
                .WithColumn(nameof(AuditTrail.EntityId)).AsInt32().NotNullable()
                ...
                .WithColumn(nameof(AuditTrail.ChangedOnUtc)).AsDateTime2().NotNullable()
                .WithColumn(nameof(AuditTrail.ActionId)).AsInt32().NotNullable()
